...
function individual = ge_createIndividual (genome_length, grammar, runGeno2Pheno)
    ...
    individual=struct('genome', randi([0 500000], genome_length, 1), 'fitness', 500000, 'testFitness', 500000, 'ID', [0 0], 'left_parent', [0 0], 'right_parent', [0 0], 'isEvaluated', 0, 'age', 0, 'result', [], 'slope', 1, 'intercept', 0);
